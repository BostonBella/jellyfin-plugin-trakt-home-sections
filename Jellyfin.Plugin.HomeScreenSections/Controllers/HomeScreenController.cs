using Jellyfin.Plugin.TraktHomeSections;
...
using Jellyfin.Plugin.TraktHomeSections.Model;
...
namespace Jellyfin.Plugin.TraktHomeSections.Controllers
{
    ...
    public class HomeScreenController : ControllerBase
    {
        ...
        private void SetCacheHeaders()
        {
            ...
            Response.Headers["ETag"] = $"\"v{Plugin.Instance.Version}-c{config.CacheBustCounter}\"";
        }
        ...
        public ActionResult GetPluginScript()
        {
            Stream? stream = Assembly.GetExecutingAssembly()
                .GetManifestResourceStream(typeof(Plugin).Namespace +
        ...
        public ActionResult BustCache()
        {
            try
            {
                Plugin.Instance.BustCache();

              
                m_homeScreenManager.RefreshSections();

                var newCounter = Plugin.Instance.Configuration.CacheBustCounter;
        ...
        public async Task<ActionResult> MakeDiscoverRequest([FromServices] IUserManager userManager, [FromBody] DiscoverRequestPayload payload)
        {
            ...
            string? jellyseerrUrl = Plugin.Instance.Configuration.JellyseerrUrl;
            ...
            client.DefaultRequestHeaders.Add("X-Api-Key", Plugin.Instance.Configuration.JellyseerrApiKey);
