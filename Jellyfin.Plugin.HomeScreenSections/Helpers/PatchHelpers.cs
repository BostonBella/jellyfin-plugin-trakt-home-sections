...
public class PatchHelpers
{
    ...
    {
        if (!Plugin.Instance.Configuration.OverrideStreamyfinHome)
        {
            return;
        }
            ...
            __instance is ControllerBase controller)
        {
            ...
            HomeScreenSectionService hssService = Plugin.Instance.ServiceProvider.GetRequiredService<HomeScreenSectionService>();
