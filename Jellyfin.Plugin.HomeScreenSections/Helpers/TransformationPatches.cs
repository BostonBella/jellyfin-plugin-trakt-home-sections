...
namespace Jellyfin.Plugin.TraktHomeSections.Helpers
{
    public static class TransformationPatches
    {
        public static string LoadSections(PatchRequestPayload content)
        {
            ...
            Stream replacementStream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"{typeof(Plugin).Namespace}.Controllers.loadSections.js")!;
        ...
        public static string IndexHtml(PatchRequestPayload content)
        {
            ...
            string pluginVersion = Plugin.Instance.GetCurrentPluginVersion();
            ...
            string replacementText1 = $"<script type=\"text/javascript\" plugin=\"Jellyfin.Plugin.TraktHomeSections\" src=\"{rootPath}/HomeScreen/home-screen-sections.js{cacheParam}\" defer></script>";
