...
namespace Jellyfin.Plugin.TraktHomeSections.HomeScreen.Sections
{
    public class DiscoverSection : IHomeScreenSection
    {
        ...
        public QueryResult<BaseItemDto> GetResults(HomeScreenSectionPayload payload, IQueryCollection queryCollection)
        {
            ...
            string? jellyseerrExternalUrl = Plugin.Instance.Configuration.JellyseerrExternalUrl;
            ...
            do 
            {
                ...
                if (discoverResponse.IsSuccessStatusCode)
                {
                    ...
                    if (jsonResponse != null)
                    {
                        ...
                        {
                            if (!string.IsNullOrEmpty(Plugin.Instance.Configuration.JellyseerrPreferredLanguages) && 
                                !Plugin.Instance.Configuration.JellyseerrPreferredLanguages.Split(',')
