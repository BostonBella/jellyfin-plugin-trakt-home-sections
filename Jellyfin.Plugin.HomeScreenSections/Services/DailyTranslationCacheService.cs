...
namespace Jellyfin.Plugin.TraktHomeSections.Services
{
    public class DailyTranslationCacheService : IScheduledTask
    {
        ...
        public string Key => "Jellyfin.Plugin.TraktHomeSections.DailyTranslationCache";
        ...
        private const string c_locPath = "src/Jellyfin.Plugin.TraktHomeSections/_Localization/";
