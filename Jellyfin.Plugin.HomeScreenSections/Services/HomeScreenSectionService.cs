...
namespace Jellyfin.Plugin.TraktHomeSections.Services
{
    public class HomeScreenSectionService
    {
        ...
        public HomeScreenSectionService(IHomeScreenManager homeScreenManager,
            ILogger<Plugin> logger, ITranslationManager translationManager,
        ...
        public void CacheSectionsForUser(Guid userId, Guid? pageHash = null)
        {
            ...
            IGrouping<int, SectionSettings>[] groupedOrderedSections = Plugin.Instance.Configuration.SectionSettings
        ...
        private HomeScreenSectionInfo SectionToInfo(IHomeScreenSection section, int configuredOrder, string? language)
        {
            ...
            info.ViewMode = Plugin.Instance.Configuration.SectionSettings.FirstOrDefault(y => y.SectionId == info.Section)?.ViewMode ?? info.ViewMode ?? SectionViewMode.Landscape;
