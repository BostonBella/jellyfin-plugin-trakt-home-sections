...
namespace Jellyfin.Plugin.TraktHomeSections.Services
{
    public class StartupService : IScheduledTask
    {
        ...
        public string Key => "Jellyfin.Plugin.TraktHomeSections.Startup";
        ...
        public StartupService(IServerApplicationHost serverApplicationHost, IApplicationPaths applicationPaths, ILogger<Plugin> logger)
        {
