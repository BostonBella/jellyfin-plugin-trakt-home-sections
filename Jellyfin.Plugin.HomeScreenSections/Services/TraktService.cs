...
namespace Jellyfin.Plugin.TraktHomeSections.Services
{
    ...
    public class TraktService
    {
        ...
        private static string TraktClientId => Plugin.Instance.Configuration.TraktClientId ?? string.Empty;

        private static string TraktClientSecret => Plugin.Instance.Configuration.TraktClientSecret ?? string.Empty;
